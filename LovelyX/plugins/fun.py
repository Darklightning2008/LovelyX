...
@lovely.on_message(filters.command("cat", prefixes=HANDLER) & filters.me)
...
@lovely.on_message(filters.regex("baka") & filters.me)
...
@lovely.on_message(filters.regex("hug") & filters.me)
...
@lovely.on_message(filters.command("in", prefixes=HANDLER) & filters.me)
...
@lovely.on_message(filters.command("ri", prefixes=HANDLER) & filters.me)
...
@lovely.on_message(filters.command("qu", prefixes=HANDLER) & filters.me)
async def quote(_, m):
...
@lovely.on_message(filters.command("gt", prefixes=HANDLER) & filters.me)
